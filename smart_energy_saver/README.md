...
**[INSERIR IMAGEM DO CIRCUITO MONTADO NO WOKWI AQUI]**
...
**[LINK PARA O REPOSITÓRIO GIT AQUI]**

*Observação: Certifique-se de que o código `main.ino` esteja devidamente comentado, explicando a lógica de cada seção.*
